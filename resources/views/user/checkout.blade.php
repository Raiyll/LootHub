            ...
            <div class="col-lg-8">
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    ...
                    <div class="card-header border-0 py-3 px-4"
                        style="background: linear-gradient(135deg, #4ee6b3 0%, #ff3399 100%);">
                        ...
                        @foreach ($cart as $id => $details)
                            ...
                            <div class="item-card position-relative mb-3 {{ !$loop->last ? 'pb-3 border-bottom' : '' }}">
                                <div class="d-flex align-items-start {{ $isDeleted ? 'opacity-50' : '' }}">
                                    ...
                                    <div class="position-relative overflow-hidden rounded-3 flex-shrink-0"
                                        style="width: 100px; height: 100px; border: 2px solid #4ee6b3;">
                                    ...
                                    <div class="ms-3 flex-grow-1">
                                        ...
                                        <div class="d-flex align-items-center gap-2 mb-2">
                                            ...
                                            <span class="fw-semibold" style="color: #ff3399;">Rp
                                                {{ number_format($details['price']) }}</span>
                                        </div>
                                    ...
                                    <div class="text-end ms-3">
                                        <div class="fw-bold fs-5"
                                            style="background: #ff3399; -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text;">
                ...
                <div class="row g-3 mt-2">
                    <div class="col-4">
                        <div class="text-center p-3 rounded-3"
                            style="background: linear-gradient(135deg, rgba(78, 230, 179, 0.1) 0%, rgba(78, 230, 179, 0.2) 100%);">
                    ...
                    <div class="col-4">
                        <div class="text-center p-3 rounded-3"
                            style="background: linear-gradient(135deg, rgba(255, 51, 153, 0.1) 0%, rgba(255, 51, 153, 0.2) 100%);">
                    ...
                    <div class="col-4">
                        <div class="text-center p-3 rounded-3"
                            style="background: linear-gradient(135deg, rgba(78, 230, 179, 0.1) 0%, rgba(255, 51, 153, 0.1) 100%);">
                ...
                <div class="sticky-top" style="top: 20px;">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="p-4">
                                ...
                                <form action="{{ route('checkout.process') }}" method="POST">
                                    @csrf
                                    {{-- Input hidden buat kirim data dari URL ke Controller --}}
                                    <input type="hidden" name="payment_method" value="{{ request('payment_method') }}">
                                    <input type="hidden" name="pay_amount" value="{{ request('pay_amount') }}">
                    ...
                    <div class="card border-0 shadow-sm rounded-4 mt-3 overflow-hidden">
                        <div class="card-body p-3"
                            style="background: linear-gradient(135deg, rgba(78, 230, 179, 0.15) 0%, rgba(255, 51, 153, 0.15) 100%);">
                            <div class="d-flex align-items-center">
