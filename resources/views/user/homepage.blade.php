...
<div class="container mt-4">
    ...
    <div id="steamCarousel" class="carousel slide shadow-lg mb-5 position-relative overflow-hidden" data-bs-ride="carousel" data-bs-interval="4000">
        ...
        <div class="carousel-inner rounded-4">
            <div class="carousel-item active">
                <div class="parallax-wrapper">
                    <img src="https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070" class="d-block w-100 banner-img parallax-img">
                ...
                <div class="carousel-caption d-none d-md-block text-start p-4 slide-in-left">
                    ...
                    <p class="fs-5 mb-4">Dapatkan diskon gila-gilaan sampai <span class="highlight-text">80%</span> untuk semua gaming gear.</p>
            ...
            <div class="carousel-item">
                <div class="parallax-wrapper">
                    <img src="https://images.unsplash.com/photo-1593305841991-05c297ba4575?q=80&w=2057" class="d-block w-100 banner-img parallax-img">
                    <div class="gradient-overlay"></div>
                </div>
                <div class="carousel-caption d-none d-md-block text-start p-4 text-white slide-in-right">
                    ...
                    <p class="fs-5 mb-4">Upgrade setup gaming lu dengan gear paling <span class="highlight-text">gahar</span> tahun ini.</p>
            ...
            <div class="carousel-item">
                <div class="parallax-wrapper">
                    <img src="https://images.unsplash.com/photo-1571716846252-df1324ce17bb?q=80&w=1170" class="d-block w-100 banner-img parallax-img">
                    <div class="gradient-overlay"></div>
                </div>
                <div class="carousel-caption d-none d-md-block text-start p-4 slide-in-bottom">
                    ...
                    <p class="fs-5 mb-4">Precision gaming. Feel the vibration, <span class="highlight-text">dominate</span> the game.</p>
                    ...
                    <div class="product-card" data-aos="fade-up" data-aos-delay="{{ $loop->index * 50 }}">
                        <div class="card h-100 border-0 card-hover glass-effect">
                            ...
                            <div class="card-body text-center d-flex flex-column p-3">
                                <a href="{{ route('product.show', $p->id) }}" class="mb-3 d-block overflow-hidden rounded-3 img-container">
                                    @if($p->image)
                                    <img src="{{ asset('storage/' . $p->image) }}" class="product-img" loading="lazy">
                                    @else
                                    <img src="https://images.unsplash.com/photo-1612287230202-1ff1d85d1bdf?q=80&w=500" class="product-img" loading="lazy">
                                    @endif
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-2 border-top action-bar">
                                    <small class="stock-info">
                                        <i class="bi bi-box-seam"></i> Stok: <strong>{{ $p->stock }}</strong>
                                    </small>
                                    @if($p->stock > 0)
                                    <form action="{{ route('product.show', $p->id) }}" method="GET">
                                        @csrf
                                        <button type="submit" class="btn btn-sm btn-cart rounded-pill px-3 shadow-sm">
                                            <i class="bi bi-cart-plus-fill"></i> Beli
                                        </button>
                                    </form>
                                    @else
                                    <button class="btn-habis btn-sm rounded-pill px-3 shadow-sm" disabled>
                                        <i class="bi bi-x-circle text-white"></i> Habis wok
                                    </button>
                                    @endif
                                </div>
                            </div>
